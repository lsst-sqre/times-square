...
async def test_github(client: AsyncClient) -> None:
    ...
    await page_service.add_page(
        PageModel(
            ...
            repository_sidecar_filename="demo.yaml",
            repository_source_filename="demo.ipynb",
    ...
    await page_service.add_page(
        PageModel(
            ...
            repository_sidecar_filename="gaussian2d.yaml",
            repository_source_filename="gaussian2d.ipynb",
            repository_source_sha="1" * 40,
            repository_sidecar_sha="1" * 40,
        ),
        execute=False,
    ...
    await page_service.add_page(
        PageModel(
            ...
            repository_path_prefix="",
            repository_display_path_prefix="",
            repository_sidecar_filename="tutorialA.yaml",
            repository_source_filename="tutorialA.ipynb",
            repository_source_sha="1" * 40,
            repository_sidecar_sha="1" * 40,
        ),
        execute=False,
