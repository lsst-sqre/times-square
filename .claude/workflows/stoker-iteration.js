// stoker-managed: workflows:.claude/workflows/stoker-iteration.js:b7ec311ddecf07d9
export const meta = {
...
const result = await agent(kind.build(args), options)
